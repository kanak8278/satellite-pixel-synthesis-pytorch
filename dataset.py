    ...
    def __getitem__(self, index):
        ...
        for i in range(self.n):
            for j in range(self.n - 1):
                ...
                sentinel_ij = tt.patch_crop_dim3(sentinel, i * self.crop_size, j * self.crop_size + half_size,
                                                 self.crop_size)
        ...
        for j in range(self.n):
            for i in range(self.n - 1):
                ...
                sentinel_ij = tt.patch_crop_dim3(sentinel, i * self.crop_size + half_size, j * self.crop_size,
                                                 self.crop_size)
...
class FMoWSentinel2(Dataset):
    ...
    def __getitem__(self, index):
        ...
        coords = tt.convert_to_coord_uneven_t(1, self.resolution, self.resolution, t,
